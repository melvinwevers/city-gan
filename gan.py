...
def get_samples():
    ...
    vutils.save_image(samples, "generated_samples/samples_{}_{}_{}.png".format(path, opt.numSamples, opt.manualSeed), normalize=True, nrow=number_of_rows_to_plot)
...
def plot_along_grid(a, b, steps):
    ...
    vutils.save_image(samples, "generated_samples/samples_{}_{}_{}_{}_{}.png".format(path, a, b, opt.numSamples, opt.manualSeed), normalize=True, nrow=number_of_rows_to_plot)
